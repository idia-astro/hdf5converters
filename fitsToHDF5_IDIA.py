...
if __name__ == '__main__':
    ...
    parser.add_argument('-c', '--chunks', help='Chunks to use, Format: Z,Y,X', default=None)
    parser.add_argument('-s', '--stokes', help='Stokes parameter to assign', default='')
    args = parser.parse_args()

    inputFileName = args.filename
    
    stokesParm = args.stokes
    if stokesParm:
